...
if st.session_state.ruolo == "utente":
    ...
    # ---------- INSERISCI ----------
        ...
        if macro_tmp == "ACCETTAZIONE":
            ...
            with st.expander("Dettagli referti"):
                ...
                tipo_malattia_ref = st.selectbox("Tipo di malattia", ["-- Seleziona --", "FSHD", "Genetica oculare", "Neuropsichiatria"], key="tipo_malattia_ref")
    ...
    # ---------- MODIFICA ----------
        ...
        if df_mio.empty:
            ...
            mal_opts = ["-- Seleziona --", "FSHD", "Genetica oculare", "Neuropsichiatria"]
